...
group3 <- c("dave_cmass_sap.out", "dave_cmass_leaf.out", "dave_cmass_root.out", "dave_cmass_repr.out",
            "dave_cmass_sap_limit.out", "dave_cmass_leaf_limit.out", "dave_cmass_root_limit.out", "dave_cmass_repr_limit.out")
# group4 <- c("dave_cgrow.out")
group4 <- c("dave_cgrow_sap.out","dave_cgrow_leaf.out", "dave_cgrow_root.out", "dave_cgrow_repr.out",
            "dave_dturnover_sap.out", "dave_dturnover_leaf.out", "dave_dturnover_root.out")
group5 <- c("dave_cmass_storage.out", "dave_cmass_storage_max.out", "dave_cexcess.out", "dave_cmass_storage_dynam.out")
group6 <- c( "dave_dalpha_leaf.out","dave_dalpha_root.out","dave_dalpha_sap.out", "dave_dalpha_repr.out")
variable_to_plot <- c(group1, group2, group3, group4, group5, group6)
